...
.IDS_UTIL_Padding_Horizontal() {
  ...
  .IDS_BREAKPOINT_MQ_ExtraSmall_Min({padding-left: var(--ids-size-spacing-32); padding-right: var(--ids-size-spacing-32);});
  .IDS_BREAKPOINT_MQ_Smaller_Min({padding-left: var(--ids-size-spacing-40); padding-right: var(--ids-size-spacing-40);});
}

.IDS_UTIL_Margin_Horizontal_Negative() {
  margin-left: calc(var(--ids-size-spacing-24) * -1);
  margin-right: calc(var(--ids-size-spacing-24) * -1);
  .IDS_BREAKPOINT_MQ_ExtraSmall_Min({margin-left: calc(var(--ids-size-spacing-32) * -1); margin-right: calc(var(--ids-size-spacing-32) * -1);});
  .IDS_BREAKPOINT_MQ_Smaller_Min({margin-left: calc(var(--ids-size-spacing-40) * -1); margin-right: calc(var(--ids-size-spacing-40) * -1);});
}

.IDS_UTIL_Padding_Horizontal_Wide() {
  .IDS_BREAKPOINT_MQ_Xxl_Min({padding-left: var(--ids-size-spacing-56); padding-right: var(--ids-size-spacing-56);});
}
