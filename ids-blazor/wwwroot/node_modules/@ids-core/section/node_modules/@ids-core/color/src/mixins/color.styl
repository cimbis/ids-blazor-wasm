IDS_COLOR_GetCorrectContrastColor($color, $ratio = 5)
  if(contrast($color-text-lightest-beige, $color).ratio > $ratio){
    color $color-text-lightest-beige
  } else if(contrast($color-text-brown, $color).ratio > $ratio){
