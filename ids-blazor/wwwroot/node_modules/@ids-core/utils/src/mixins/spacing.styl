...
IDS_UTIL_GenerateBreakpointMarginsForSpacing($spacingName, $spacingSize)
    for $break, $value in $breakpointMin
        +IDS_BREAKPOINT_MQUp($break) {
            IDS_UTIL_GenerateBreakpointMarginForSideAndSpacing($break, top, $spacingName, $spacingSize)
            IDS_UTIL_GenerateBreakpointMarginForSideAndSpacing($break, right, $spacingName, $spacingSize)
            IDS_UTIL_GenerateBreakpointMarginForSideAndSpacing($break, bottom, $spacingName, $spacingSize)
            IDS_UTIL_GenerateBreakpointMarginForSideAndSpacing($break, left, $spacingName, $spacingSize)
        }

IDS_UTIL_GenerateBreakpointPaddingsForSpacing($spacingName, $spacingSize)
    for $break, $value in $breakpointMin
        +IDS_BREAKPOINT_MQUp($break) {
            IDS_UTIL_GenerateBreakpointPaddingForSideAndSpacing($break, top, $spacingName, $spacingSize)
            IDS_UTIL_GenerateBreakpointPaddingForSideAndSpacing($break, right, $spacingName, $spacingSize)
            IDS_UTIL_GenerateBreakpointPaddingForSideAndSpacing($break, bottom, $spacingName, $spacingSize)
            IDS_UTIL_GenerateBreakpointPaddingForSideAndSpacing($break, left, $spacingName, $spacingSize)
        }

IDS_UTIL_GenerateBreakpointMargins()
    for $spacingName, $spacingSize in $spacings
        IDS_UTIL_GenerateBreakpointMarginsForSpacing($spacingName, $spacingSize)
